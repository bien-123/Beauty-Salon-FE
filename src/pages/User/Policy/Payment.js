    ...
    <>
      <div className="w-[1050px] m-auto flex flex-col items-start justify-start py-8 gap-2  text-start">
        <div className="hr-underline">
          <div className="text-2xl text-[#02a7aa] font-bold mb-2">Chính sách thanh toán tại Viện Thẩm Mỹ Beauty</div>
        </div>
        ...
        <div className="text-base">
          Phương thức thanh toán bằng tiền mặt áp dụng trong trường hợp khách hàng hoàn thành việc thanh toán khi sử
          dụng các dịch vụ tại viện thẩm mỹ Beauty và thanh toán bằng tiền mặt trực tiếp tại địa chỉ của bệnh viện.
        </div>
        <div className="font-bold text-xl">2. Phương thức thanh toán chuyển khoản ngân hàng</div>
        <div className="text-base ">
          Phương thức thanh toán bằng chuyển khoản khi khách hàng ở xa, quý khách hàng không muốn thanh toán trực tiếp
          bằng tiền mặt thì khách hàng có nhu cầu sử dụng phương thức thanh toán này.
        </div>
        <div className="flex w-[550px] m-auto">
          ...
          <div className="flex border-2 border-solid border-[#01babd] p-2">
            <div className="text-base flex flex-col">
              ...
              <div>
                <strong>MB-BANK NGÂN HÀNG QUÂN ĐỘI</strong> chi nhánh Xuân Mai, Thị Trấn Xuân Mai, Huyện Chương Mỹ,
                Thành Phố Hà Nội
              </div>
            </div>
          </div>
